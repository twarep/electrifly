...
class query_flights:
    ...
    def get_flights_act_view(self, columns: list):
        """
        The function runs the following query: SELECT id, flight_date FROM labeled_activities_view. This gets all the flight id's and dates of the flight.
        """
    ...
    def get_flight_power_soc_rate(self, flight_ids: list):
        ...
        fw_flight_id: {time: [], motor_power: [], soc: [], soc_rate_of_change: []}
        """
        ...
        for id in flight_ids:
            ...
            # Get the flight data
            flights_df = self.get_flight_data_every_half_min_on_id(["fw_flight_id", "time_min", "motor_power", "bat_1_soc", "bat_2_soc"], id)
    ...
    # Get Flight Id, Temperature and SOC rate Function -------------------------------------------------------------------------
    def get_flight_temperature_soc_rate(self, flight_ids: list):
        """
        ...
        # Get time, Temperature, soc, and soc rate data for the specific flight(s)
        for id in flight_ids:

            # Get the flight data
            flights_df = self.get_flight_data_every_half_min_on_id(["fw_flight_id", "time_min", "temperature", "bat_1_soc", "bat_2_soc"], id)
            ...
            flight_dict[id] = {"time_min": times, "temperature": temperature, "soc": soc, "soc_rate_of_change": soc_rate_of_change}
