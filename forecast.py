...
# get data
api_url = "https://api.open-meteo.com/v1/forecast?latitude=43.4668&longitude=-80.5164&minutely_15=temperature_2m,weathercode,windgusts_10m,visibility,lightning_potential&hourly=winddirection_10m&windspeed_unit=kn&timezone=America%2FNew_York&forecast_days=3"
...
df_combined.insert(0, 'forecast_time_utc', df_combined['time'].dt.time)
