...
app_ui = ui.page_fluid(
    ...
    ui.navset_card_pill(  
        ...
        ui.nav_panel("ElectriFly",
            ...
            """)),
            div(HTML(f"""
                  <h1 style="text-align: center; font-weight: bolder; padding: 2rem 0">
                           <span>Welcome to ElectriFly's</span>
                           <span style="color: {blue};">PPC #2,</span>
                           <span>please try out our features and leave us any feedback you have!</span>
                         </h1>  
          """)),
